      ...
      {open && (
        <div className="addnode-body">
          ...
          <p className="addnode-note addnode-note--small">
            The host's name defaults to its hostname and{" "}
            <strong>must match its Prometheus job_name</strong>, or it shows
            containers with no host metrics. Pass <code>--name</code> if they
            differ. If this dashboard has <code>API_TOKEN</code> set, add{" "}
